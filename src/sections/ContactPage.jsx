  ...
  return (
    <div className="flex md:flex-row flex-col md:items-center justify-between md:gap-20 gap-5 items-center">
      ...
      <div className="p-2 relative">
        ...
        >
          <img
            src="https://growthrocket.media/_next/image?url=%2Ffounder.jpg&w=1920&q=75"
            alt=""
            className="w-[55vh] h-[] rounded-xl object-cover"
          />
        </TwoCardsEffect>
        <div className="bg-gradient-to-r from-yellow-500 to-red-600 py-2 absolute bottom-[500px] md:bottom-[540px] w-fit md:right-56 right-[160px] text-black font-medium -rotate-[5deg] rounded-xl px-10 text-sm md:text-[16px] whitespace-nowrap">
          <h1>Ayushman Pandita</h1>
      ...
      <div className="md:w-[100vh]">
        ...
        <p className="text-[20px] md:text-2xl my-4 md:my-10 font-light mb-56 md:mb-48">
          ...
          on YouTube for India's youth. After his success on Youtube, he
          launched his Instagram account in August 2022 and scaled to 1 lakh
          followers in less than 4 months. <br /> <br /> Ayushman completed his
          BTech in Computer Science from IIITD in 2020. He previously worked as
          a Software Engineer at HSBC and as a Product Manager at BharatPe.
        </p>
      </div>
    </div>
  );
